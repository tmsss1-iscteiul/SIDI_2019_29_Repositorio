...
CREATE TABLE `medicoes_consultados_log` (
  ...
  `DataHora_LOG` timestamp NOT NULL,
  PRIMARY KEY (`ID`),
  UNIQUE KEY `ID_UNIQUE` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `cultura` (`IDCultura`, `Email_Investigador`, `NomeCultura`, `DescricaoCultura`) VALUES (1,'root@localhost','Cultura de teste do RooT','TESTE ROOT'),(2,'root@localhost','Cultura de teste do RooT 2','TESTE ROOT 2'),(3,'email1@teste.tt','Cultura de teste do tt','TESTE tt'),(4,'root@localhost','Cultura de teste do RooT 2','TESTE ROOT 2');
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `cultura_AFTER_UPDATE` AFTER UPDATE ON `cultura` FOR EACH ROW BEGIN
	insert into 
    culturalog (
				IDCultura_OLD,
                IDCultura_NEW, 
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `cultura_AFTER_DELETE` AFTER DELETE ON `cultura` FOR EACH ROW BEGIN
...
INSERT INTO `investigador` (`Email`, `NomeInvestigador`, `CategoriaProfissional`) VALUES ('email1@teste.tt','test','test'),('email2@teste.tt','test','test'),('email3@teste.tt','test','test'),('root@localhost','ROOT','ROOT');
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `investigador_AFTER_UPDATE` AFTER UPDATE ON `investigador` FOR EACH ROW BEGIN
	Insert into 
...
LOCK TABLES `investigador_log` WRITE;
/*!40000 ALTER TABLE `investigador_log` DISABLE KEYS */;
INSERT INTO `investigador_log` (`ID`, `Email_OLD`, `Email_NEW`, `NomeInvestigador_OLD`, `NomeInvestigador_NEW`, `CategoriaProfissional_OLD`, `CategoriaProfissional_NEW`, `Operacao`, `Utilizador`, `DataHora`) VALUES (1,NULL,'email2@teste.tt',NULL,'test',NULL,'test','I','root@localhost','2019-03-05 11:52:53'),(2,NULL,'email3@teste.tt',NULL,'test',NULL,'test','I','root@localhost','2019-03-05 11:52:54');
/*!40000 ALTER TABLE `investigador_log` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `medicoes` (`NumeroMedicao`, `IDVariaveis_VariaveisMedidas`, `IDCultura_VariaveisMedidas`, `ValorMedicao`, `DataHoraMedicao`) VALUES (1,1,1,345.00,'2019-03-04 20:23:32'),(2,1,1,0.00,'2019-03-04 20:23:32'),(3,1,1,0.00,'2019-03-04 20:23:32'),(4,1,1,33.00,'2019-03-04 20:23:32'),(5,1,1,10000.00,'2019-03-04 20:23:32'),(6,2,3,50.00,'2019-03-04 20:28:59'),(7,1,2,60.00,'2019-03-05 11:10:31'),(8,1,2,650.00,'2019-03-05 11:54:41'),(9,1,2,320.00,'2019-03-05 11:54:52');
...
LOCK TABLES `medicoes_consultados_log` WRITE;
/*!40000 ALTER TABLE `medicoes_consultados_log` DISABLE KEYS */;
INSERT INTO `medicoes_consultados_log` (`ID`, `IDMedicoes_LOG`, `NumeroMedicao`, `IDVariaveis_VariaveisMedidas`, `IDCultura_VariaveisMedidas`, `ValorMedicao`, `DataHoraMedicao`, `Operacao_LOG`, `Utilizador_LOG`, `DataHora_LOG`) VALUES (1,NULL,1,1,1,345.00,'2019-03-04 20:23:32','S','root@localhost','2019-03-05 11:00:52'),(2,NULL,2,1,1,0.00,'2019-03-04 20:23:32','S','root@localhost','2019-03-05 11:00:52'),(3,NULL,3,1,1,0.00,'2019-03-04 20:23:32','S','root@localhost','2019-03-05 11:00:52'),(4,NULL,4,1,1,33.00,'2019-03-04 20:23:32','S','root@localhost','2019-03-05 11:00:52'),(5,NULL,5,1,1,10000.00,'2019-03-04 20:23:32','S','root@localhost','2019-03-05 11:00:52'),(6,'15',1,1,1,345.00,'2019-03-04 20:23:32','S','root@localhost','2019-03-05 11:02:33'),(7,'15',2,1,1,0.00,'2019-03-04 20:23:32','S','root@localhost','2019-03-05 11:02:33'),(8,'15',3,1,1,0.00,'2019-03-04 20:23:32','S','root@localhost','2019-03-05 11:02:33'),(9,'15',4,1,1,33.00,'2019-03-04 20:23:32','S','root@localhost','2019-03-05 11:02:33'),(10,'15',5,1,1,10000.00,'2019-03-04 20:23:32','S','root@localhost','2019-03-05 11:02:33'),(11,'16',2,1,1,0.00,'2019-03-04 20:23:32','S','root@localhost','2019-03-05 11:02:54'),(12,'16',3,1,1,0.00,'2019-03-04 20:23:32','S','root@localhost','2019-03-05 11:02:54'),(13,'19',1,1,1,345.00,'2019-03-04 20:23:32','S','root@localhost','2019-03-05 11:05:46'),(14,'19',2,1,1,0.00,'2019-03-04 20:23:32','S','root@localhost','2019-03-05 11:05:46'),(15,'19',3,1,1,0.00,'2019-03-04 20:23:32','S','root@localhost','2019-03-05 11:05:46'),(16,'19',4,1,1,33.00,'2019-03-04 20:23:32','S','root@localhost','2019-03-05 11:05:46'),(17,'19',5,1,1,10000.00,'2019-03-04 20:23:32','S','root@localhost','2019-03-05 11:05:46'),(18,'20',1,1,1,345.00,'2019-03-04 20:23:32','S','root@localhost','2019-03-05 11:07:54'),(19,'20',2,1,1,0.00,'2019-03-04 20:23:32','S','root@localhost','2019-03-05 11:07:54'),(20,'20',3,1,1,0.00,'2019-03-04 20:23:32','S','root@localhost','2019-03-05 11:07:54'),(21,'20',4,1,1,33.00,'2019-03-04 20:23:32','S','root@localhost','2019-03-05 11:07:54'),(22,'20',5,1,1,10000.00,'2019-03-04 20:23:32','S','root@localhost','2019-03-05 11:07:54'),(25,'23',1,1,1,345.00,'2019-03-04 20:23:32','S','root@localhost','2019-03-05 11:10:55'),(26,'23',2,1,1,0.00,'2019-03-04 20:23:32','S','root@localhost','2019-03-05 11:10:55'),(27,'23',3,1,1,0.00,'2019-03-04 20:23:32','S','root@localhost','2019-03-05 11:10:55'),(28,'23',4,1,1,33.00,'2019-03-04 20:23:32','S','root@localhost','2019-03-05 11:10:55'),(29,'23',5,1,1,10000.00,'2019-03-04 20:23:32','S','root@localhost','2019-03-05 11:10:55'),(30,'23',7,1,2,60.00,'2019-03-05 11:10:31','S','root@localhost','2019-03-05 11:10:55'),(32,'24',1,1,1,345.00,'2019-03-04 20:23:32','S','root@localhost','2019-03-05 11:26:33'),(33,'24',2,1,1,0.00,'2019-03-04 20:23:32','S','root@localhost','2019-03-05 11:26:33'),(34,'24',3,1,1,0.00,'2019-03-04 20:23:32','S','root@localhost','2019-03-05 11:26:33'),(35,'24',4,1,1,33.00,'2019-03-04 20:23:32','S','root@localhost','2019-03-05 11:26:33'),(36,'24',5,1,1,10000.00,'2019-03-04 20:23:32','S','root@localhost','2019-03-05 11:26:33'),(37,'24',7,1,2,60.00,'2019-03-05 11:10:31','S','root@localhost','2019-03-05 11:26:33');
/*!40000 ALTER TABLE `medicoes_consultados_log` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `medicoes_log` WRITE;
/*!40000 ALTER TABLE `medicoes_log` DISABLE KEYS */;
INSERT INTO `medicoes_log` (`ID`, `NumeroMedicao_OLD`, `NumeroMedicao_NEW`, `DataHoraMedicao_OLD`, `DataHoraMedicao_NEW`, `ValorMedicao_OLD`, `ValorMedicao_NEW`, `IDVariaveis_VariaveisMedidas_OLD`, `IDVariaveis_VariaveisMedidas_NEW`, `IDCultura_VariaveisMedidas_OLD`, `IDCultura_VariaveisMedidas_NEW`, `Operacao`, `Utilizador`, `DataHora`) VALUES (1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'S','root@localhost','2019-03-05 09:57:40'),(2,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'S','root@localhost','2019-03-05 09:57:44'),(3,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'S','root@localhost','2019-03-05 09:57:47'),(4,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'S','root@localhost','2019-03-05 10:16:07'),(5,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'S','root@localhost','2019-03-05 10:16:12'),(6,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'S','root@localhost','2019-03-05 10:16:27'),(7,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'S','root@localhost','2019-03-05 10:16:40'),(8,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'S','root@localhost','2019-03-05 10:23:51'),(9,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'S','root@localhost','2019-03-05 10:24:00'),(10,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'S','root@localhost','2019-03-05 10:24:15'),(11,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'S','root@localhost','2019-03-05 10:55:28'),(12,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'S','root@localhost','2019-03-05 10:58:36'),(13,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'S','root@localhost','2019-03-05 10:59:56'),(14,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'S','root@localhost','2019-03-05 11:00:52'),(15,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'S','root@localhost','2019-03-05 11:02:33'),(16,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'S','root@localhost','2019-03-05 11:02:54'),(17,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'S','root@localhost','2019-03-05 11:04:06'),(18,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'S','root@localhost','2019-03-05 11:05:28'),(19,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'S','root@localhost','2019-03-05 11:05:46'),(20,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'S','root@localhost','2019-03-05 11:07:54'),(21,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'S','root@localhost','2019-03-05 11:08:18'),(22,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'S','root@localhost','2019-03-05 11:08:49'),(23,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'S','root@localhost','2019-03-05 11:10:55'),(24,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'S','root@localhost','2019-03-05 11:26:33'),(25,NULL,8,NULL,'2019-03-05 11:54:41',NULL,650.00,NULL,1,NULL,2,'I','root@localhost','2019-03-05 11:54:41'),(26,NULL,9,NULL,'2019-03-05 11:54:52',NULL,320.00,NULL,1,NULL,2,'I','root@localhost','2019-03-05 11:54:52'),(27,5,NULL,'2019-03-04 20:23:32',NULL,10000.00,NULL,1,NULL,1,NULL,'U','root@localhost','2019-03-05 11:55:24'),(28,5,NULL,'2019-03-04 20:23:32',NULL,10000.00,10.00,1,NULL,1,NULL,'U','root@localhost','2019-03-05 11:55:57'),(29,5,NULL,'2019-03-04 20:23:32',NULL,10.00,10000.00,1,NULL,1,NULL,'U','root@localhost','2019-03-05 11:56:29');
/*!40000 ALTER TABLE `medicoes_log` ENABLE KEYS */;
UNLOCK TABLES;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `variaveis_AFTER_UPDATE` AFTER UPDATE ON `variaveis` FOR EACH ROW BEGIN
	insert into variaveis_log (
								IDVariavel_OLD, 
                                IDVariavel_NEW, 
                                NomeVariavel_OLD, 
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `variaveis_AFTER_DELETE` AFTER DELETE ON `variaveis` FOR EACH ROW BEGIN
	insert into variaveis_log (
								IDVariavel_OLD, 
                                IDVariavel_NEW, 
                                NomeVariavel_OLD, 
...
LOCK TABLES `variaveis_log` WRITE;
/*!40000 ALTER TABLE `variaveis_log` DISABLE KEYS */;
INSERT INTO `variaveis_log` (`ID`, `IDVariavel_OLD`, `IDVariavel_NEW`, `NomeVariavel_OLD`, `NomeVariavel_NEW`, `Operacao`, `Utilizador`, `DataHora`) VALUES (1,NULL,3,NULL,'Variavel de Teste 3','I','root@localhost','2019-03-05 11:53:56');
/*!40000 ALTER TABLE `variaveis_log` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `variaveismedidas` (`IDVariavel_Variaveis`, `IDCultura_Cultura`, `LimiteInferior`, `LimiteSuperior`) VALUES (1,1,30.00,40.00),(1,2,30.00,40.00),(2,1,30.00,40.00),(2,2,30.00,40.00),(2,3,30.00,40.00),(2,4,30.00,40.00);
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `variaveismedidas_AFTER_UPDATE` AFTER UPDATE ON `variaveismedidas` FOR EACH ROW BEGIN
	insert into variaveismedidas_log(
										LimiteInferior_OLD, 
                                        LimiteInferior_NEW, 
                                        LimiteSuperior_OLD, 
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `variaveismedidas_AFTER_DELETE` AFTER DELETE ON `variaveismedidas` FOR EACH ROW BEGIN
	insert into variaveismedidas_log (
										LimiteInferior_OLD, 
                                        LimiteInferior_NEW, 
                                        LimiteSuperior_OLD, 
...
LOCK TABLES `variaveismedidas_log` WRITE;
/*!40000 ALTER TABLE `variaveismedidas_log` DISABLE KEYS */;
INSERT INTO `variaveismedidas_log` (`ID`, `LimiteInferior_OLD`, `LimiteInferior_NEW`, `LimiteSuperior_OLD`, `LimiteSuperior_NEW`, `IDVariavel_Variaveis_OLD`, `IDVariavel_Variaveis_NEW`, `IDCultura_Cultura_OLD`, `IDCultura_Cultura_NEW`, `Operacao`, `Utilizador`, `DataHora`) VALUES (1,NULL,30.00,NULL,40.00,NULL,2,NULL,4,'I','root@localhost','2019-03-05 11:54:21');
/*!40000 ALTER TABLE `variaveismedidas_log` ENABLE KEYS */;
UNLOCK TABLES;
...
--
/*!50003 DROP PROCEDURE IF EXISTS `ApagarUtilizadores` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `ApagarUtilizadores`()
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `InserirUtilizadores` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `InserirUtilizadores`(IN email_SP varchar(50), IN pass_SP varchar(50), IN nomeinvestigador_SP varchar(100), IN categoriaprofissional_SP varchar(300))
BEGIN
...
-- Dump completed on 2019-03-05 11:58:27
