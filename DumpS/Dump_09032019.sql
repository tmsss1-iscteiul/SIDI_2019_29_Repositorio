...
INSERT INTO `investigador` (`Email`, `NomeInvestigador`, `CategoriaProfissional`) VALUES ('email2@teste.tt','test','test'),('email3@teste.tt','test','test'),('investigador2@hotmail.com','Investigador 1','Professor'),('investigador@hotmail.com','Investigador 1','Professor'),('root@localhost','ROOT','ROOT');
...
LOCK TABLES `investigador_log` WRITE;
/*!40000 ALTER TABLE `investigador_log` DISABLE KEYS */;
INSERT INTO `investigador_log` (`ID`, `Email_OLD`, `Email_NEW`, `NomeInvestigador_OLD`, `NomeInvestigador_NEW`, `CategoriaProfissional_OLD`, `CategoriaProfissional_NEW`, `Flag_Migracao`, `Operacao`, `Utilizador`, `DataHora`) VALUES (1,NULL,'email2@teste.tt',NULL,'test',NULL,'test',0,'I','root@localhost','2019-03-05 11:52:53'),(2,NULL,'email3@teste.tt',NULL,'test',NULL,'test',0,'I','root@localhost','2019-03-05 11:52:54'),(3,NULL,'investigador1@hotmail.com',NULL,'Investigador 1',NULL,'Professor',0,'I','root@localhost','2019-03-05 12:39:14'),(4,'investigador1@hotmail.com','investigador@hotmail.com','Investigador 1',NULL,'Professor',NULL,0,'U','root@localhost','2019-03-05 12:42:59'),(5,NULL,'investigador2@hotmail.com',NULL,'Investigador 1',NULL,'Professor',0,'I','root@localhost','2019-03-05 12:54:28'),(6,'email1@teste.tt',NULL,'test',NULL,'test',NULL,0,'D','root@localhost','2019-03-09 09:50:44');
/*!40000 ALTER TABLE `investigador_log` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `variaveis_log` WRITE;
/*!40000 ALTER TABLE `variaveis_log` DISABLE KEYS */;
INSERT INTO `variaveis_log` (`ID`, `IDVariavel_OLD`, `IDVariavel_NEW`, `NomeVariavel_OLD`, `NomeVariavel_NEW`, `Flag_Migracao`, `Operacao`, `Utilizador`, `DataHora`) VALUES (1,NULL,3,NULL,'Variavel de Teste 3',0,'I','root@localhost','2019-03-05 11:53:56'),(2,3,NULL,'Variavel de Teste 3',NULL,0,'D','root@localhost','2019-03-09 09:46:23');
/*!40000 ALTER TABLE `variaveis_log` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `variaveismedidas_log` WRITE;
/*!40000 ALTER TABLE `variaveismedidas_log` DISABLE KEYS */;
INSERT INTO `variaveismedidas_log` (`ID`, `LimiteInferior_OLD`, `LimiteInferior_NEW`, `LimiteSuperior_OLD`, `LimiteSuperior_NEW`, `IDVariavel_Variaveis_OLD`, `IDVariavel_Variaveis_NEW`, `IDCultura_Cultura_OLD`, `IDCultura_Cultura_NEW`, `Flag_Migracao`, `Operacao`, `Utilizador`, `DataHora`) VALUES (1,NULL,30.00,NULL,40.00,NULL,2,NULL,4,0,'I','root@localhost','2019-03-05 11:54:21');
/*!40000 ALTER TABLE `variaveismedidas_log` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2019-03-09 11:54:10
